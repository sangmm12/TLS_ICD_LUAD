...
library(dplyr)
  ...
  setwd("C:/Users/a/Desktop/LUAD/10.Rank/3.1.Sur_rank_TLS")
  
      all_sur_data <- fread(paste('C:/Users/a/Desktop/LUAD/10.Rank/3.1.Sur_rank_TLS/sur_',sample_name,'.csv',sep=''),header=T)
      all_sur_data <- as.data.frame(all_sur_data)
      
      my_data <- fread("C:/Users/a/Desktop/LUAD/10.Rank/3.1.Sur_rank_TLS/Exp_TCGA_TLS.csv", header = T) ##自己改的代码，直接读取Exp
      ...
      source("C:/Users/a/Desktop/LUAD/10.Rank/3.1.Sur_rank_TLS/msvmRFE.R")
